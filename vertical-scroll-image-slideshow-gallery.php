...
Description:  This (VS slideshow) is a simple Image Vertical scroll slideshow Gallery plugin for WordPress with javascript.
Author: Gopi.R
Version: 3.0
Author URI: http://www.gopiplus.com/work/
Donate link: http://www.gopiplus.com/work/2010/07/18/vertical-scroll-image-slideshow-gallery/
VS means VERTICAL SCROLL
*/
...
function VSslideshow_control() 
{
	...
	echo '<br>Default: wp-content/plugins/vertical-scroll-image-slideshow-gallery/VSslideshow/</p>';
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-image-slideshow-gallery/'>Click here</a> to post suggestion or comments or feedback. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-image-slideshow-gallery/'>Click here</a> to see live demo. <br> 
...
{
  	register_sidebar_widget(__('VS slideshow'), 'VSslideshow_widget');   
	
	if(function_exists('register_sidebar_widget')) 	
	{
		register_sidebar_widget('VS slideshow', 'VSslideshow_widget');
	}
	
	if(function_exists('register_widget_control')) 	
	{
		register_widget_control(array('VS slideshow', 'widgets'), 'VSslideshow_control',500,400);
	} 
}
