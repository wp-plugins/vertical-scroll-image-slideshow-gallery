...
function VSslideshow_control() 
{
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-image-slideshow-gallery/'>Click here</a> to see comments. <br> 
...
function VSslideshow_widget_init() 
{
	...
	{
		register_widget_control(array('VS slideshow', 'widgets'), 'VSslideshow_control',650,400);
	} 
}
